...
INSERT INTO public.tipo_prestamo (nombre, monto_minimo, monto_maximo, tasa_interes, validacion_automatica) VALUES('Crédito libre inversión', 5000000.00, 20000000.00, 0.5000, false) ON CONFLICT DO NOTHING;